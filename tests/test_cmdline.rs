...
mod tests {
    ...
    #[test]
    fn test_clustering_low_memory_tab_characters() {
        Assert::main_binary()
            .with_args(&[
                "cluster",
                "--genome-fasta-files",
                ...
                .stdout()
                .is("\
                tests/data/abisko_tabs/73.20120800_S1D.21.fna	tests/data/abisko_tabs/73.20120800_S1D.21.fna\n\
                tests/data/abisko_tabs/73.20120800_S1D.21.fna	tests/data/abisko_tabs/73.20110800_S2M.16.fna\n")
                .unwrap();
    }
