...
3. To do the final expensive tests, use `CHECKM2DB=/work/microbiome/db/CheckM2_database/uniref100.KO.1.dmnd ISITEUK_METAPACKAGE_PATH=/work/microbiome/db/isiteuk/isiteuk-0.0.1.smpkg EUKCC2_DB=/work/microbiome/db/eukcc/eukcc2_db_ver_1.1 pixi run cargo test -- --ignored`
